...
export const PLAYER_BULLETS_MAX_COUNT = 10;

export const ENEMY_FIGHTER_SCORE = 200;
export const ENEMY_FIGHTER_HEALTH = 2;
export const ENEMY_FIGHTER_MOVEMENT_VERTICAL_VELOCITY = 8; 
...
export const ENEMY_FIGHTER_GROUP_SPAWN_INTERVAL = 8000;
...
export const ENEMY_SCOUT_MOVEMENT_VERTICAL_VELOCITY = 6; 
export const ENEMY_SCOUT_MOVEMENT_HORIZONTAL_VELOCITY = 9;
export const ENEMY_SCOUT_GROUP_SPAWN_INTERVAL = 6000; 
